...
const docTemplate = `{
    ...
    "paths": {
        "/admin/admin-role": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Admin Role Create Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/admin-role/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Admin Role Update Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/user": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Admin User Create Request",
                        "name": "user",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/user/{id}/admin-role": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Assign Admin Role Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UserAssignAdminRoleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/user/{id}/change-password": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Change Admin Password Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ChangeAdminPasswordRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.ChangeAdminPasswordRequest": {
            "type": "object",
            "required": [
                "new_password"
            ],
        ...
        "dto.ChangePasswordRequest": {
            ...
            "properties": {
                "except_token": {
                    "description": "excepted refresh token",
                    "type": "string"
                },
                "new_password": {
                    "type": "string",
        ...
        "dto.UserAssignAdminRoleRequest": {
            "type": "object",
            "required": [
                "admin_role_id"
            ],
